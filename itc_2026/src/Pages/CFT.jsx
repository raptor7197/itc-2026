...
function CFT() {
    ...
    return (
       ...
       <div className="mt-16">
        <img src='/CFTheading.png' style={{width:'100vw', zIndex:'-50'}} alt="Call for Tutorials Heading">
       ...
       <div className="mt-10 textbg">
        ...
        <div className="mt-12 w-[100vw]  md:gap-0 ">
            <div className="flex flex-col items-center md:flex-row justify-evenly">
                <div className="bg-[#00E0FF] text-center mb-6 md:mb-0 font-bold lg:w-[25vw] md:w-[30vw] w-[60vw] lg:text-[1.4vw] md:text-[1.7vw] text-[3.5vw] px-7 py-3" style={{borderRadius:"60px"}}>Tutorial Submission Deadline<br/> 31st March, 2026</div>
                <div className="bg-[#00E0FF] text-center md:mb-0 font-bold lg:w-[25vw] md:w-[30vw] w-[60vw] lg:text-[1.4vw] md:text-[1.7vw] text-[3.5vw] px-7 py-3" style={{borderRadius:"60px"}}>Final Manuscript Due<br/> 13th June, 2026</div>
            </div>
            <div className="flex flex-row md:mt-12 mt-6 mb-6 justify-evenly">
                <div className="bg-[#00E0FF] text-center mb-6 md:mb-0 font-bold md:w-[30vw] lg:w-[25vw] w-[60vw] lg:text-[1.4vw] md:text-[1.7vw] text-[3.5vw] px-7 py-3" style={{borderRadius:"60px"}}>Author Notification<br/> 12th May, 2026</div>
                </div>
        </div>
...
<p className="text-justify text-white text-xl mt-10 mx-10">Authors are invited to submit original, high quality, practical and industry best practices as Tutorials describing recent work in the field of test and design.</p>
        ...
        <div className="mt-10 mx-8 p-6 rounded-xl border-4 border-blue-500 text-white text-xl" style={{fontFamily:'"Poppins", arial'}}>
            <ul className="list-disc ml-10 space-y-4">
                <li>A tutorial proposal needs to be submitted in template available on ITC India website</li>
                <li>Submission link <a href="https://easychair.org/my/conference?conf=itcindia2026" className="font-bold underline">https://easychair.org/my/conference?conf=itcindia2026</a></li>
                <li>The following details are mandatory:
                    <ul className="list-disc ml-10 mt-2 space-y-2">
                        <li>Tutorial title</li>
                        <li>Tutorial abstract</li>
                        <li>Topics and subtopics to be covered, and the approximate time devoted to each topic</li>
                        <li>The targeted audience and prerequisites</li>
                        <li>Preferred tutorial duration : 3 hours (for full tutorials) or 1.5 hours (for short tutorials)</li>
                        <li>Name, affiliation, bio of each author</li>
                    </ul>
                </li>
                <li>Proposals will undergo a panel review process</li>
                <li>All presenters listed in the tutorial proposal must be available for tutorial presentation</li>
                <li>Consent should be obtained from all the presenters and all organizations involved in presenting the material before making the tutorial proposal</li>
                <li>If proposal is accepted, final presentation must be shared by final manuscript due date for review</li>
                <li>Accepted tutorial abstracts will be published in conference proceedings</li>
            </ul>
             <div className="mt-8 text-lg">
                <p>Note: For detailed information about the submission process, requirements and deadlines, the selection process and any other questions regarding the program itself or contact information, please consult the ITC India web site at <a href="http://www.itctestweekindia.org" className="text-blue-300">http://www.itctestweekindia.org</a> or email the tutorial chair at <a href="mailto:ITC-India-2026-Tutorials@easychair.org" className="text-blue-300">ITC-India-2026-Tutorials@easychair.org</a></p>
            </div>
        </div>
        </div>
        ...
        <div className="mt-10 text-blue-500 text-4xl lg:text-5xl font-bold text-center">Topics of interest include (not limited to)</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-32 lg:gap-x-64 gap-y-8 mx-8 my-16">
                {topics.map((topic, index) => (
                    <div key={index} className="text-white text-xl lg:text-2xl px-6 font-semibold text-center bg-gray-700 py-4 rounded-3xl w-[80vw] md:w-[35vw] lg:w-[29vw]">
                        {topic}
                    </div>
                ))}
            </div>
            ...
            <img src='/Mask group.webp' className="lg:h-[8vw] h-[12vw]" alt=""></img>
            <img src='/Mask group.webp' className="lg:h-[8vw] h-[12vw]" alt=""></img>
            <img src='/Mask group.webp' className="lg:h-[8vw] h-[12vw]" alt=""></img>
          </Marquee>
