...
>>>>>>> upstream/main
        ...
        <div>
          <div className="text-gray-500 flex flex-row justify-center text-center text-lg font-semibold cursor-default">
            {props.company}
          </div>
        </div>
      </div>
        ...
        <div className="flex justify-center items-end">
          <div className="absolute bottom-[35px]">
            <svg
              ...
              width="16"
              height="16"
              className="bi bi-linkedin fill-white hover:fill-blue-700 hover:scale-[1.2] duration-300"
              viewBox="0 0 16 16"
            >
