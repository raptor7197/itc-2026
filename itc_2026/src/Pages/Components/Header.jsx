    ...
    <>
      <div className="herobg  pt-2 pb-10 pr-8 flex flex-col md:flex-row justify-evenly lg:gap-16  md:pl-16 w-[100vw] z-[-1]  items-center">
        ...
        <div className=" flex flex-col gap-4 ml-8 md:ml-12">
          ...
          >
            <div
              className="p-[1vw] md:px-[2vw] px-[2.2vw] font-bold  text-center text-[2.1vw] md:text-[1vw]"
              style={{
                borderRadius: "20px",
                backgroundColor: "rgba(200, 219, 254, 50%)",
              }}
            >
              JULY 19-21, 2026
            </div>
            <Link
              to="https://maps.app.goo.gl/Su9eU1hLBaaRZcKEA"
              className=" p-[1vw] px-[2vw] text-center font-bold text-[2.1vw] md:text-[1vw]"
              style={{
                borderRadius: "20px",
                backgroundColor: "rgba(200, 219, 254, 50%)",
              }}
      ...
      >
        <nav
          aria-label="Global"
          className=" flex text-2xl justify-center items-center  pt-6 pb-6 lg:px-8"
        >
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5">
                <span className="sr-only">ITC 2026</span>
              </a>
              <button
                type="button"
                onClick={() => setMobileMenuOpen(false)}
